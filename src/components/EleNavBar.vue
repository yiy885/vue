<template>
  ...
  >
    <el-menu-item index="/">
      <img style="width: 50px" src="../assets/img/ci-an/logo/ceromony-logo-w.png" alt="Logo" />
    </el-menu-item>
    <el-menu-item v-for="item in navItems" :key="item.to" :index="item.to" v-show="item.show">
      {{ item.title }}
    </el-menu-item>
  </el-menu>
</template>
